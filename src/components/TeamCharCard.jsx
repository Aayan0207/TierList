      ...
      <div className="char_card">
        <div className="char_details">
          <div className="img_container">
            ...
            ></img>
            <img
              className={char_data.rarity == 4 ? "char_img star_4 char_team_img" : "char_img char_team_img"}
          ...
          <div className="char_role">{char.role}</div>
        </div>
        <div className="char_equipment">
          <div className="char_weapon_container">
            <img
              className={char.weapon.rarity == 5 ? "char_weapon" : "char_weapon char_weapon_4"}
              src={`../weapon_icons/Weapon_${char.weapon.name}_2nd.png`}
            ></img>
          </div>
          <div className="char_artifact_container">
            <img
              className={char.artifact.rarity == 5 ? "char_artifact" : "char_artifact char_artifact_4"}
